  ...
  if (typeof json === 'object') {
    return Object.keys(json).map(function (key) {
      ...
      if (value === {} || value === undefined) {
        return "<D:" + key + (root ? " xmlns:D=\"DAV:\"" : "") + "/>";
      }
      return "<D:" + key + (root ? " xmlns:D=\"DAV:\"" : "") + ">" + render(value) + "</D:" + key + ">";
    }).join("\n");
  }
  return json;
}
...
exports.renderKeyStartTag = function (key, root) {
  return "<D:"+key+ (root ? " xmlns:D=\"DAV:\">" : ">");
}
exports.renderKeyEndTag = function (key) {
  return "</D:"+key+">";
}
exports.renderDoc = function (json) {
